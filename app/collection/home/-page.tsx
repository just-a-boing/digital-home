...
export default function HomePage() {
  ...
  const handleFileSelection = (
    ...
    if (invalidFile) {
      ...
      setUploadError(
        `"${invalidFile.name}" is not a valid image or video file.`
      );
    ...
    if (oversizedImage) {
      ...
      setUploadError(
        `"${oversizedImage.name}" is larger than 10 MB.`
      );
    ...
    if (oversizedVideo) {
      ...
      setUploadError(
        `"${oversizedVideo.name}" is larger than 100 MB.`
      );
  ...
  const uploadSingleMedia = async (
    ...
    if (!signedUrl) {
      throw new Error(
        `${selectedFile.name}: Media uploaded but a temporary URL could not be created.`
      );
    }
      ...
      <section className="w-full px-5 pb-14 pt-20 sm:px-10 sm:pb-20 sm:pt-28">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#81766d]">
            Places, ideas, furniture, little details,
            <br />
            and things we would love to have someday.
          </p>
      ...
      {media.length === 0 && (
        <section className="flex min-h-[40vh] flex-col items-center justify-center px-5 py-24 text-center">
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-[#81766d]">
            ...
            <br />
            Maybe the first idea belongs here.
          </p>
              ...
              0 ? (
                ...
                <>
                  ...
                  <p className="mt-3 text-[9px] uppercase tracking-[0.15em] text-[#81766d]/70">
                    Images · 10 MB each · Videos · 100 MB each
                  </p>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="shrink-0 rounded-full bg-[#5d3928]/10 px-2 py-0.5 text-[8px] uppercase tracking-[0.15em] text-[#5d3928]">
                          ...
                          <p className="mt-1 truncate text-xs font-medium text-[#28231f]">
                            {file.name}
                          </p>
