...
export default function ForHerPage() {
  ...
  useEffect(() => {
    ...
    const loadMedia = async () => {
      ...
      try {
        ...
        const loadedMedia: GalleryMedia[] = [];
        ...
        for (const item of data ?? []) {
          ...
          if (!signedUrl) {
            console.error(
              "Skipping media because signed URL failed:",
              item.media_url
            );
  ...
  const uploadSingleMedia = async (
    ...
    filePath = isVideo
      ? `forher/videos/${fileName}`
      : `forher/images/${fileName}`;

    console.log(
      "Uploading For Her media:",
      filePath
    );
    ...
    if (!signedUrl) {
      throw new Error(
        `${selectedFile.name}: Could not create temporary media URL.`
      );
    }
  ...
  const handleUpload = async () => {
    if (selectedFiles.length === 0) {
      setUploadError(
        "Please choose at least one picture or video."
      );
      ...
      <section className="relative h-[65svh] min-h-[450px] w-full overflow-hidden sm:h-[70svh] sm:min-h-[520px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center text-white">
          ...
          <p className="mt-6 max-w-md text-sm leading-7 text-white/80 sm:text-base">
            Little things, beautiful ideas,
            <br />
            and everything meant just for her.
          </p>
      ...
      <section className="w-full px-5 pb-14 pt-20 sm:px-10 sm:pb-20 sm:pt-28">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#81766d]">
            Ideas, inspiration, pictures and little
            things
            <br />
      ...
      {media.length === 0 && (
        <section className="flex min-h-[40vh] flex-col items-center justify-center px-5 py-24 text-center">
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-[#81766d]">
            ...
            <br />
            Maybe the first thing belongs here.
          </p>
              ...
              {selectedFiles.length > 0 ? (
                <>
                  ...
                  <p className="mt-4 text-[9px] uppercase tracking-[0.2em] text-[#8b4b3f]">
                    Images and videos upload one by one
                  </p>
                </>
              ) : (
                <>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] text-[#8b4b3f]">
                              {file.type.startsWith(
                                "video/"
                              )
                                ? "VIDEO"
