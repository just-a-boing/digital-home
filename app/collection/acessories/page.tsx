...
type AccessoriesMedia = {
  media_id: string;
  media_url: string;
};

type GalleryMedia = AccessoriesMedia & {
  signedUrl: string;
  type: "image" | "video";
};
...
export default function AccessoriesPage() {
  ...
  useEffect(() => {
    ...
    const loadMedia = async () => {
      ...
      try {
        ...
        console.error(
          "Failed to load accessories media:",
          error
        );
      } finally {
        if (mounted) {
  ...
  const uploadSingleMedia = async (
    ...
    if (storageError) {
      ...
      throw new Error(
        `${selectedFile.name}: ${storageError.message}`
      );
    }
    ...
    if (databaseError) {
      ...
      throw new Error(
        `${selectedFile.name}: ${databaseError.message}`
      );
    }
    ...
    if (!signedUrl) {
      throw new Error(
        `${selectedFile.name}: Unable to create temporary media URL.`
      );
    }
    ...
    try {
      ...
      for (
        ...
        try {
          ...
          // Immediately show uploaded media
          setMedia((current) => [
            uploaded,
            ...current,
          ]);
      ...
      <main className="flex min-h-[100svh] items-center justify-center bg-[#f4f0ea]">
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] uppercase tracking-[0.3em] text-[#81766d]">
            Opening accessories collection...
          </p>
      ...
      <section className="relative h-[65svh] min-h-[450px] w-full overflow-hidden sm:h-[70svh] sm:min-h-[520px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center text-white">
          ...
          <p className="text-[10px] uppercase tracking-[0.35em] text-white/80 sm:text-xs">
            A collection of little details
          </p>
          ...
          <p className="mt-6 max-w-md text-sm leading-7 text-white/80 sm:text-base">
            Jewellery, ornaments, little details,
            <br />
      ...
      <section className="w-full px-5 pb-14 pt-20 sm:px-10 sm:pb-20 sm:pt-28">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          <h2 className="mt-4 font-serif text-4xl sm:text-5xl">
            Little things, beautiful details
          </h2>

          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#81766d]">
            Jewellery, accessories, ideas,
            <br />
            and inspiration worth remembering.
          </p>
      ...
      {media.length === 0 && (
        <section className="flex min-h-[40vh] flex-col items-center justify-center px-5 py-24 text-center">
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-[#81766d]">
            There are no accessories here yet.
            <br />
                ...
                (item, index) => (
                  ...
                  >
                    ...
                    <div className="group relative overflow-hidden rounded-[4px] bg-[#e5ddd3] shadow-[0_4px_20px_rgba(60,40,30,0.05)] transition-all duration-700 hover:-translate-y-1 hover:shadow-[0_12px_35px_rgba(60,40,30,0.10)]">
                      ...
                      {item.type ===
                        "video" && (
                        <div className="pointer-events-none absolute left-3 top-3 rounded-full bg-black/45 px-3 py-1.5 text-[8px] uppercase tracking-[0.18em] text-white backdrop-blur-sm">
                          Video
                        </div>
                      )}
              ...
              0 ? (
                ...
                <>
                  ...
                  <p className="mt-3 text-[9px] uppercase tracking-[0.15em] text-[#81766d]/70">
                    Images or videos · Maximum 100 MB each
                  </p>
                </>
              )}
