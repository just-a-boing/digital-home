...
type PhotographyMedia = {
  media_id: string;
  media_url: string;
};

type GalleryMedia = PhotographyMedia & {
  signedUrl: string;
  type: "image" | "video";
};
...
export default function PhotographyPage() {
  ...
  useEffect(() => {
    ...
    const loadMedia = async () => {
      ...
      try {
        ...
        console.error(
          "Failed to load photography media:",
          error
        );
      } finally {
        if (mounted) {
  ...
  const uploadSingleMedia = async (
    ...
    if (!signedUrl) {
      throw new Error(
        `${selectedFile.name}: Could not create a temporary media URL.`
      );
    }
      ...
      <section className="relative h-[65svh] min-h-[450px] w-full overflow-hidden sm:h-[70svh] sm:min-h-[520px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center text-white">
          ...
          <p className="mt-6 max-w-md text-sm leading-7 text-white/80 sm:text-base">
            ...
            <br />
            and moments we want to capture.
          </p>
      ...
      <section className="w-full px-5 pb-14 pt-20 sm:px-10 sm:pb-20 sm:pt-28">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#81766d]">
            References, ideas, places,
            <br />
            and photographs we love.
          </p>
      ...
      {media.length === 0 && (
        <section className="flex min-h-[40vh] flex-col items-center justify-center px-5 py-24 text-center">
          ...
          <h2 className="mt-7 font-serif text-3xl sm:text-4xl">
            Our photography collection is waiting.
          </h2>
