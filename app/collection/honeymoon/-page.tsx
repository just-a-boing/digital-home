...
type GalleryMedia = HoneymoonMedia & {
  signedUrl: string;
  type: "image" | "video";
};
...
export default function HoneymoonPage() {
  ...
  useEffect(() => {
    ...
    const loadMedia = async () => {
      ...
      try {
        ...
        console.error(
          "Failed to load honeymoon media:",
          error
        );
      } finally {
        if (mounted) {
  ...
  const uploadSingleMedia = async (
    ...
    filePath = isVideo
      ? `honeymoon/videos/${fileName}`
      : `honeymoon/images/${fileName}`;

    console.log(
      "Uploading honeymoon media:",
      filePath
    );
      ...
      <main className="flex min-h-[100svh] items-center justify-center bg-[#f4f0ea]">
        <div className="text-center">
          ...
          <p className="text-[10px] uppercase tracking-[0.3em] text-[#81766d]">
            Opening our honeymoon collection...
          </p>
      ...
      <section className="w-full px-5 pb-14 pt-20 sm:px-10 sm:pb-20 sm:pt-28">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#81766d]">
            ...
            and dreams we want to make real.
          </p>
      ...
      {media.length === 0 && (
        <section className="flex min-h-[40vh] flex-col items-center justify-center px-5 py-24 text-center">
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-[#81766d]">
            ...
            <br />
            Maybe the first dream belongs here.
          </p>
              ...
              {selectedFiles.length > 0 ? (
                <>
                  ...
                  <p className="mt-4 text-[9px] uppercase tracking-[0.2em] text-[#8b4b3f]">
                    Images and videos upload separately
                  </p>
